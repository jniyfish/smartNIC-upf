...
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__tbl_gtp_decap 1
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__far_ingress 2
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__src_intf_table 3
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__pdr_ingress 4

/* Unified control state numbers */
#define PIF_CTLFLOW_STATE__condition_0 0
#define PIF_CTLFLOW_STATE_ingress__tbl_gtp_decap 1
#define PIF_CTLFLOW_STATE_ingress__far_ingress 2
#define PIF_CTLFLOW_STATE_ingress__src_intf_table 3
#define PIF_CTLFLOW_STATE_ingress__pdr_ingress 4
