...
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__far_egress_table 0
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__src_intf_table 1
#define PIF_CTLFLOW_STATE_ingress_flow_ingress__pdr_ingress_table 2

/* Unified control state numbers */
#define PIF_CTLFLOW_STATE_ingress__far_egress_table 0
#define PIF_CTLFLOW_STATE_ingress__src_intf_table 1
#define PIF_CTLFLOW_STATE_ingress__pdr_ingress_table 2
