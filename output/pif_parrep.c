...
__label_parse_gtpu:
    { /* implementation of parse node parse_gtpu */
...
#ifndef PIF_GLOBAL_FLOWCACHE_DISABLED
        {
            ...
            _pif_fk->inner_ipv4__dst_addr = inner_ipv4->dst_addr;
...
_pif_parrep_label_exit:
    ...
    _pif_parrep_fk_ptr[(*_pif_parrep_fk_len) + 0] = _pif_parrep[PIF_PARREP_CTLDATA_OFF_LW + 0] & 0x88040000;
