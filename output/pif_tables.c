...
/* Table 0 : ingress::pdr_ingress_table */
#define PIF_TABLE_ACTIONDATA_SIZE_0 32
#define PIF_TABLE_MAX_ENTRIES_0 24501
#define PIF_TABLE_SHIFT_0 5

/* Table 1 : ingress::src_intf_table */
#define PIF_TABLE_ACTIONDATA_SIZE_1 32
#define PIF_TABLE_MAX_ENTRIES_1 33
#define PIF_TABLE_SHIFT_1 5

/* Table 2 : ingress::far_egress_table */
#define PIF_TABLE_ACTIONDATA_SIZE_2 32
#define PIF_TABLE_MAX_ENTRIES_2 16385
...
__export __emem uint32_t pif_actiondata_table_0_ingress__pdr_ingress_table[2 * PIF_TABLE_MAX_ENTRIES_0 * (PIF_TABLE_ACTIONDATA_SIZE_0 / 4)];
__export __emem uint32_t pif_actiondata_table_1_ingress__src_intf_table[2 * PIF_TABLE_MAX_ENTRIES_1 * (PIF_TABLE_ACTIONDATA_SIZE_1 / 4)];
__export __emem uint32_t pif_actiondata_table_2_ingress__far_egress_table[2 * PIF_TABLE_MAX_ENTRIES_2 * (PIF_TABLE_ACTIONDATA_SIZE_2 / 4)];
