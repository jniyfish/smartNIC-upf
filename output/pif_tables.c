...
#define PIF_TABLE_MAX_ENTRIES_0 5
#define PIF_TABLE_SHIFT_0 5

/* Table 1 : ingress::pdr_ingress_table */
...
/* Table 3 : ingress::src_intf_table */
#define PIF_TABLE_ACTIONDATA_SIZE_3 16
#define PIF_TABLE_MAX_ENTRIES_3 33
...
__export __emem uint32_t pif_actiondata_table_1_ingress__pdr_ingress_table[2 * PIF_TABLE_MAX_ENTRIES_1 * (PIF_TABLE_ACTIONDATA_SIZE_1 / 4)];
...
__export __emem uint32_t pif_actiondata_table_3_ingress__src_intf_table[2 * PIF_TABLE_MAX_ENTRIES_3 * (PIF_TABLE_ACTIONDATA_SIZE_3 / 4)];
