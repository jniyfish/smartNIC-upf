...
#define PIF_ACTION_ID_ingress__act 1
#define PIF_ACTION_ID_ingress__set_src_intf 2
#define PIF_ACTION_ID_ingress__gtp_decap 3
#define PIF_ACTION_ID_ingress__set_rules 4
#define PIF_ACTION_ID_ingress__update_mac 5
...
__packed struct pif_action_actiondata_ingress__update_mac {
